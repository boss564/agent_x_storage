...
<!-- SWARM_RUNTIME_BEGIN -->
<!-- generated_at: 2026-09-01T09:30:33.162472+00:00 -->
...
| **CrossVenueMonitor** | P1 | **ACTIVE** | 10s | `regime-swarm-0:/data/audit/cross_venue_gaps.jsonl` | Opt-in (Env default off) |
| **Regime Swarm Daemon** | P5 | **ACTIVE** | 1.7m | `regime-swarm-0:/data/audit/regime_swarm_cycles.jsonl` | Shadow-Pfad (primary) |
| **A2 DataIngestor** | P5 | **ACTIVE** | 1.7m | `regime-swarm-0:/data/audit/regime_swarm_cycles.jsonl` | Shadow-Pfad |
| **A3–A9 Drift Agents** | P5 | **ACTIVE** | 1.7m | `regime-swarm-0:/data/audit/regime_drift_audit.jsonl` | Shadow-Pfad |
| **A0 Core Sanity Gate** | P6 | **ACTIVE** | 1.7m | `regime-swarm-0:/data/audit/regime_swarm_cycles.jsonl` | Shadow-Pfad |
| **A2.5 Transport Gate** | P6 | **ACTIVE** | 1.7m | `regime-swarm-0:/data/audit/regime_swarm_cycles.jsonl` | Shadow-Pfad |
| **B0 Position Sizing** | P5 | **OFF** | — | `data/raas/audit/position_sizing_audit.jsonl` | Opt-in (Helm off, Strang B n<50) |

_Stand: 2026-09-01T09:30:33.162472+00:00 · 8 ACTIVE · 0 STALE (Laufzeit-Zeilen, nicht Rollen-Zeilen)_
