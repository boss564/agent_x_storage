...
├── rescue/                        # Katastrophenschutz: 9 Einheiten A/B/C, OODA, Sensor-to-Rescue, RoE-Clearance; Phase-Pull COORDINATED (szenarioabhängig), RoE ≠ Timing-Koppler (ΔR≈0) — docs/RESCUE_KOORDINATION_DOSSIER.md
...
- Befund 1: Phasen-Pull-Koordination real, szenarioabhängig (dicht COORDINATED
  R=0.7582 p=0.002; dünner UNCOORDINATED) — Dichte-Hypothese ausstehend (Option B)
