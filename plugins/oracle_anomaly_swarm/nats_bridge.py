"""NATS bridge — P5 ↔ Oracle Anomaly sandbox worker (Queue-Group only).

Subject: edge.P5.oracle.sandbox
Queue:   queue.edge.P5.oracle.sandbox
...
async def handle_job(body: Dict[str, Any], *, repo_root: Optional[str] = None) -> Dict[str, Any]:
    ...
    kind = str(body.get("kind", "STALE_PRICE"))
    scenario_id = str(body.get("scenario_id", "oa-nats"))
