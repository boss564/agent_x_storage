"""Hard gate for Intent-Relayer candidates (Pre-Reg §3.0.3 Schicht A)."""
...
PREREG_MARKERS = ("Pre-Reg", "pre-reg", "BRIDGE_STUFE_A_V3_PREREG", "§3.0.3")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Verify Intent-Relayer declarations")
    parser.add_argument(
        "--input",
